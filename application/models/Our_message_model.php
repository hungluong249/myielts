...
class Our_message_model extends MY_Model {

	public $table = 'our_message';
    ...
    public function count_by_our_message(){
        $this->db->select('*');
        $this->db->from($this->table);
        $this->db->join($this->table_lang, $this->table_lang .'.'. $this->table .'_id = '. $this->table .'.id');
        $this->db->group_by($this->table_lang .'.'.$this->table.'_id');
...
/* End of file Our_message_model.php */
/* Location: ./application/models/Our_message_model.php */