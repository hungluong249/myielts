        ...
        <div class="row">
                            ...
                            <div class="detail-image col-md-12">
                                ...
                                <div class="row">
                                    <div class="item col-md-12">
                                        <div class="mask-lg">
                                            <img src="<?php echo base_url('assets/upload/comments/'. $detail['image'] ) ?>" alt="Image Detail">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-3">
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <a href="<?php echo base_url('admin/comment/edit/'.$detail['id']) ?>" class="btn btn-warning" role="button">Chỉnh sửa</a>
                    </div>
                </div>
            </div>
        </div>
