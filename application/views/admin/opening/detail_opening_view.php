        ...
        <div class="row">
            <div class="col-md-9">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Lịch Khai Giảng Chi tiết</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                            <div class="detail-image col-md-6">
                                ...
                                <div class="row">
                                    <div class="item col-md-12">
                                        <div class="mask-lg">
                                            <img src="<?php echo base_url('assets/upload/openings/'. $detail['image'] ) ?>" alt="Image Detail">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-3">
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <a href="<?php echo base_url('admin/opening/edit/'.$detail['id']) ?>" class="btn btn-warning" role="button">Chỉnh sửa</a>
                    </div>
                </div>
            </div>
        </div>
