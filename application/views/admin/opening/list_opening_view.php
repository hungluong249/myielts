            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Lịch Khai Giảng</h3>
                    </div>

                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo base_url('admin/opening/create') ?>" class="btn btn-primary" role="button">Thêm mới</a>
                        </div>
                        <div class="col-md-6">
                            <form action="<?php echo base_url('admin/opening/index') ?>" method="get">
                            ...
                            <table id="table" class="table table_product">
                                ...
                                <?php foreach ($result as $key => $value): ?>
                                    <tr class="remove_<?php echo $value['id'] ?>">
                                        ...
                                        <td>
                                            <div class="mask_sm">
                                                <img src="<?php echo base_url('assets/upload/openings/'. $value['image']) ?>" alt="anh-cua-<?php echo $value['slug'] ?>" width=150 >
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0);" class="dataActionDelete btn-remove" data-controller="opening" data-id="<?php echo $value['id'] ?>" ><i class="fa fa-remove" aria-hidden="true"></i> </a>
                                        </td>
