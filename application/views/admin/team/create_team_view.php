                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="vi">
                                    ...
                                    <div class="form-group col-xs-12">
                                        ...
                                        echo form_textarea('description_vi', set_value('description_vi', '', false), 'class="form-control tinymce-area" rows="5" ')
                                        ?>
                                    </div>
                                </div>
                                <div role="tabpanel" class="tab-pane" id="en">
                                    ...
                                    <div class="form-group col-xs-12">
                                        ...
                                        echo form_textarea('description_en', set_value('description_en', '', false), 'class="form-control tinymce-area" rows="5" ')
                                        ?>
                                    </div>
                                </div>
                            </div>
