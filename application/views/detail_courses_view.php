					...
					<div class="table-responsive">
						<table class="table table-bordered">
							...
							<tr>
								...
								<td>13/08/2018</td>
								<td>
									In sed feugiat lorem. Etiam gravida risus vitae enim iaculis, in tincidunt nisi rhoncus. Vivamus quis elit et mi ultrices placerat eget id dolor. Proin tellus eros, venenatis eu rutrum commodo, dignissim vel libero. Nulla et magna dictum mi aliquam porttitor sed eu lectus. Praesent pretium feugiat tristique. Curabitur dignissim, augue quis imperdiet lobortis, sapien dui egestas libero, ac aliquet odio mauris ut sapien. Etiam tristique quis turpis eget iaculis.
								</td>
							</tr>
							<tr>
								<td>2</td>
						...
						<br>
						<small class="visible-xs">Slide left to see more</small>
					</div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
						<div class="row">
							...
							<div class="col-xs-12">
                                <?php echo form_submit('submit', 'Register to take Advise', 'class="btn btn-primary"'); ?>
							</div>
